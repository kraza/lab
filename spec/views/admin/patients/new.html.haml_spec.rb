...
describe "admin/patients/new.html.haml" do
  before(:each) do
    assign(:admin_patient, stub_model(Admin::Patient,
  ...
  it "renders new admin_patient form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => admin_patients_path, :method => "post" do
