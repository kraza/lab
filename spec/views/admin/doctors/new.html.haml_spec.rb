...
describe "admin/doctors/new.html.haml" do
  before(:each) do
    assign(:admin_doctor, stub_model(Admin::Doctor,
      :code => "MyString",
      :first_name => "MyString",
      :last_name => "MyString",
  ...
  it "renders new admin_doctor form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => admin_doctors_path, :method => "post" do
